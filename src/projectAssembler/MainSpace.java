...
public class MainSpace extends Application{
		...
		private String jarPathString;
                ...
                DeleteNode DeletableNode = new DeleteNode();
                TriangleEnable TriEn = new TriangleEnable();/*default is false*/
                CircleEnable CircEn = new CircleEnable();
                LineEnable LineEn = new LineEnable();
                RectangleEnable RecEn = new RectangleEnable();
                Boolean UndoBtnIsPressed = FALSE;
                Boolean NodeIsLive = FALSE;
                AfterMove Moved = new AfterMove();/*Default is False*/
	...
	/**
	 * This method returns the horizontal box pane.
	 * This pane contains -till now- the color picker.
	 * @return
	 */
	...
	/**
	 * This returns the vertical box pane.
	 * That contains the 3 shapes buttons
	 * @return
	 */
...
//                moveBut.setStyle("-fx-color:black");
	...
	private ImageView circleButton(){
		...
		circleImg.setOnMouseClicked(e->{
			...
			circle.create(this.drawSpace,this.undo,redo,DeletableNode,CircEn);                       
                      /*  if(!undo.isEmpty()){
                        ObservableList<Node> pop = undo.pop();
                        if (!UndoHandler.containsSmallObjects(pop)){
                           undo.push(pop);
                        }
                        }*/
		});
	...
	private ImageView lineButton(){
		...
		Button loadBut = new Button();
                ...
                Image image = new Image("projectAssembler/Icons/load.png",35,30,true,true);
